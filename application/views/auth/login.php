...
<style>
    ...
    .glass-input-group .form-control {
        ...
        font-size: 1rem !important; /* Forces normal text scaling matching the sign-up form controls */
        font-weight: 400 !important; /* Uniform weight rules across layout inputs */
    }
