...
<section class="content pt-4">
    <div class="container-fluid">
        ...
        <div class="card border-0 shadow-sm p-4 p-md-5 bg-white">
            <?php $this->load->view('shared/documents/_invoice_header', ['invoice' => $invoice]); ?>
            <?php $this->load->view('shared/documents/_invoice_items', ['items' => $items]); ?>
            <?php $this->load->view('shared/documents/_invoice_totals', ['invoice' => $invoice]); ?>
        </div>
    </div>
</section>