...
<section class="content pt-4">
    <div class="container-fluid">
        ...
        <!-- Search Framework (Conditioned on Admin visibility preference or fallback) -->
        <?php if (!empty($isAdmin) && $isAdmin): ?>
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-3">
                    <form method="GET" action="<?= site_url($invoiceRoute); ?>" class="row g-2 align-items-end">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 d-flex gap-2">
                            ...
                            <a href="<?= site_url($invoiceRoute); ?>" class="btn btn-light text-secondary fw-medium border" style="font-size: 0.9rem; padding: 0.5rem 1rem;">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-4 text-end text-nowrap">
                                            <div class="d-inline-flex gap-1">
                                                <a href="<?= site_url($invoiceRoute . (!empty($isAdmin) && $isAdmin ? '/view/' : '/show/') . $row->id); ?>" class="btn btn-outline-dark btn-sm rounded-pill font-medium" style="font-size: 0.75rem; padding: 0.25rem 0.75rem;">
                                                    <i class="fas fa-eye me-1" style="font-size: 0.7rem;"></i> View Details
                                                </a>
                                                <a href="<?= site_url($invoiceRoute . '/download/' . $row->id); ?>" class="btn btn-outline-danger btn-sm rounded-pill font-medium" style="font-size: 0.75rem; padding: 0.25rem 0.75rem;">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="<?= (!empty($isAdmin) && $isAdmin) ? '7' : '6'; ?>" class="text-center text-muted py-5">
